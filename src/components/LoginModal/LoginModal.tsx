    ...
    <div className="fixed inset-0 flex items-center justify-center z-40">
      ...
      <div className="bg-white rounded-lg p-8 z-50 w-[90%] max-w-[30rem]">
        ...
        <p className="text-gray-700 text-center text-lg">
          You need to be logged in before you can perform this action.
        </p>
        <div className="flex justify-around">
          ...
          <button
            className="mt-6 rounded-full border border-primary hover:text-primary hover:bg-transparent active:scale-90 font-medium text-blue py-2 px-8 transition duration-300"
            onClick={onClose}
          >
            Close
          </button>
